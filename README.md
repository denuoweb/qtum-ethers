...
const mainnetProvider = new Provider("https://janus.htmlcoin.com/api/");
const testnetProvider = new Provider("https://testnet-janus.htmlcoin.com/api/");
...
// const signer = HtmlcoinWallet.createRandom(/*{ path = SLIP_BIP44_PATH }*/}).connect(provider);
...
async function transferToken(contractAddress, from, to, value) {
    const hrc20 = new Contract(contractAddress, HRC_ABI, signer)
